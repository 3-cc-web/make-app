    ...
    return (
        <div>
            <div className="flex justify-center">
                ...
                {imagePath ? (
                    <div className="w-[150px] h-[150px] flex items-center justify-center border-[#d9d9d9] border-[1px] bg-white rounded-lg overflow-hidden">
                        <Image src={getImageUrl(imagePath)} alt='商品画像' width={150} height={150}
